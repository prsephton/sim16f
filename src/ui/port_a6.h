	...
	class PortA6: public CairoDrawing {
	  ...
	  public:
			...
			m_cpu(a_cpu), m_refGlade(a_refGlade)
		{
			...
			m_components["Pin"]  = new PinDiagram(p6.pin(), 630, 150, m_area);
			...
			m_components["RD_PORTA"]  = new ConnectionDiagram(Tristate2.rd(), 100, 445, m_area);
			m_components["Tristate3"]  = new TristateDiagram(Tristate3, false, 250, 380, m_area);
			m_components["RD_TRISA"]  = new ConnectionDiagram(Tristate3.rd(), 100, 380, m_area);
